...
public class Init {
    ...
    public QuoteClient getQuoteClientAPIs(){ return this.APIs; }
    ...
    public boolean loginSession(SessionID sessionID){
        try{
